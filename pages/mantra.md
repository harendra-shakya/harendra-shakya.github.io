...
permalink: /mantra/
layout: page
excerpt: Concise, lyrical mantra capturing fleeting moments of clarity and wisdom.
description: Concise, lyrical mantra capturing fleeting moments of clarity and wisdom.
comments: false
---
...
<div class="lang-toggle">
  ...
  {% assign all_tags = site.mantra | map: 'tags' | flatten | uniq %}
  {% for tag in all_tags %}
...
{%- assign sorted_mantra = site.mantra | sort: "date" | reverse -%}
{%- assign previous_year = "" -%}

{%- for post in sorted_mantra -%}
